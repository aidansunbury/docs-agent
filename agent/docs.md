...
- Omarchy - `${HOME}/.docs-agent/resources/omarchy`
- OpenCode - `${HOME}/.docs-agent/resources/opencode`
- Scalar - `${HOME}/.docs-agent/resources/scalar`
- hyprwhspr - `${HOME}/.docs-agent/resources/hyprwhspr`
